...
public class CustFriendTagCriteria {
    /**
     ...
     * This class corresponds to the database table cust_friend_tag
     *
     * @mbggenerated Fri Jan 26 17:54:01 CST 2018
     */
    ...
    public class BoundBuilder {
        ...
        public CustFriendTagCriteria build() {
            CustFriendTagCriteria.this.limit = limit;
            CustFriendTagCriteria.this.offset = offset;
            return CustFriendTagCriteria.this;
        }
    }
}